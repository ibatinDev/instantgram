export default {
  'langs': {
    ...
    'es-AR': {
      ...
      'modules.update@determineIfGetUpdateIsNecessary_contacting': '[instantgram] está buscando nuevas actualizaciones…',
      'modules.update@determineIfGetUpdateIsNecessary_updated': '[instantgram] actualizó a la versión actual.',
